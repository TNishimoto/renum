...
#include <set>
#include <queue>
#include "../../include/basic/char_interval.hpp"
...
template class stool::renum::CharInterval<uint32_t, uint8_t>;
template class stool::renum::CharInterval<uint64_t, uint8_t>;
